  ...
  return (
    <div className="bg-[#FFF0E9] mx-auto p-4 md:p-8 lg:p-12">
      <div className="text-[#000] font-manrope text-xl md:text-2xl lg:text-3xl font-bold mb-4 md:mb-6">
        Bhojanalays <span className="text-[#E14503]">In Rishikesh</span>
      </div>
